...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    programs.fish = {
      ...
      loginShellInit = "fish_add_path --move --prepend --path $HOME/.nix-profile/bin /run/wrappers/bin /etc/profiles/per-user/${config.home.username}/bin /run/system-manager/sw/bin /run/current-system/sw/bin /nix/var/nix/profiles/default/bin";
